...
| `team_Jarvis2.0.csv` | Final submission output |
...
==================================================
  ...
  [OK] Submission file present: team_Jarvis2.0.csv
...
====================================================================
SUCCESS: Pipeline iteration completed cleanly. Data target established at: team_Jarvis2.0.csv
```
...
| 2 | Generate submission | `python rank_candidates.py --out team_Jarvis2.0.csv` | 100 rows, 0 honeypots in shortlist |
| 3 | Official validation | `python validate_submission.py team_Jarvis2.0.csv` | `Submission is valid.` |
...
1. `team_Jarvis2.0.csv` — ranked shortlist with reasoning
